...
- sshd 
- ssh
permalink: ssh-fu-wu-duan-pei-zhi
id: 54
updated: '2016-03-05 01:42:17'
date: 2016-03-05 01:32:03
---

> 最近，在使用U盘安装gentoo配置sshd服务端碰到了问题，记录一下ssh服务端的配置文件。
...
### 登入设定部分
```
PermitRootLogin no　　 　　# 是否允许 root 登入！最新版本的sshd配置默认是不允许使用root登陆的，如果要使用root登陆，要把no 改为 yes 。
